...
# Vendored from SimonZeng7108/efficientsam3 @ d063e00 (sam3/backbones/efficientvit/nn/drop.py); intra-package imports rewritten.
...
class DropPathResidualBlock(ResidualBlock):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        if not self.training or self.drop_prob == 0 or not isinstance(self.shortcut, IdentityLayer):
            ...
            if self.scheduled:
                drop_prob *= 1.0  # np.clip(Scheduler.PROGRESS, 0, 1)
