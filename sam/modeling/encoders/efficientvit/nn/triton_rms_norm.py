...
# Vendored from SimonZeng7108/efficientsam3 @ d063e00 (sam3/backbones/efficientvit/nn/triton_rms_norm.py); intra-package imports rewritten.
# Upstream source: MIT-HAN-Lab/efficientvit (Apache-2.0)
# NOTE: This file is only executed when triton is installed (CUDA env).
# On CPU/Windows environments without triton, nn/norm.py's try/except catches the
# ImportError and sets _TRITON_AVAILABLE=False, so the pure-torch fallback is used.
import torch
import triton
