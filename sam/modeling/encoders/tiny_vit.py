...
# Vendored from SimonZeng7108/efficientsam3 @ d063e00 (sam3/backbones/tiny_vit.py); de-timm'd.
# --------------------------------------------------------
...
from sam.modeling.encoders.pe_vitdet import DropPath as TimmDropPath
from sam.modeling.encoders._layers import to_2tuple
...
class TinyViT(nn.Module):
    def __init__(self, img_size=224, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            ...
            # Update resolution for next layer (PatchMerging uses Conv2d stride=2, pad=1, k=3)
            # Output size = floor((n + 2*1 - 3) / 2) + 1 = floor((n - 1) / 2) + 1
