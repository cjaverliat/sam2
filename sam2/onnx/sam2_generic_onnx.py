...
from sam2.onnx.image_encoder_onnx import ImageEncoderOnnx
from sam2.onnx.mask_decoder_onnx import MaskDecoderOnnx
from sam2.onnx.memory_attention_onnx import MemoryAttentionOnnx
from sam2.onnx.memory_encoder_onnx import MemoryEncoderOnnx
from sam2.onnx.prompt_encoder_onnx import PromptEncoderOnnx
...
def attach_onnx_blocks(
    ...
    :func:`sam2.build_sam.build_sam2_generic_video_predictor_onnx`): no real weights
